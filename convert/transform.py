...
year= str('J'+yea)
totalnumbers = int(input('How many long/lat coordinates do you want to enter: '))

for x in range(0, totalnumbers):

    long = int(input('Longitude [Degrees]: '))
    lat = int(input('Latitude [Degrees]: '))
